...
<body>
    ...
    <h1>
        <div class="first">“If we want users to like <br>
            our software, we should design <br>
            it to behave like a likeable<br>
            person.”</div>
        <div class="second"> <br> </div>
        <div class="third"></div>
    </h1>
    <div class="d">
        <p> &nbsp;"Technology | Analyst |engineering "</p>
...
<body>
    <header>
        ...
        <div class="cirpic">
            <img class="small border" src="me.jpeg" width="500px">
            <img class="small border" src="av.jpeg" width="500px" >
            <img class="small border" src="th.jpeg" width="500px">
            <img class="small border" src="har.jpeg" width="500px" >
            <img class="small border" src="gi.jpeg" width="500px">
            <img class="small border" src="pio.jpeg" width="500px" >
        </div>
        <div class ="text">
            <table style="color:rgb(244, 242, 242);" cellpadding="70">
                <tr div class="head">
                    <th>Shree Lekha</th>
                    <th>Menon</th>
                    <th>Thor       </th>
        ...
        <div class="text2">
            <table style="color:rgb(244, 242, 242);" cellpadding="85">
                <tr >
                    <td>founder</td>
                    <td>Co-Founder</td>
                    <td>CEO</td>
...
<body>
    ...
    <div class="gallery">
       <a target="_blank" href="qwd.png">
         <img src="qwd.png"  center" alt="Cinque Terre" width="1500" height="600">
       </a>
   </div>
        <div class="cirpic">
...
<head>
    ...
    <body>
        ...
        <div class="info">
            ...
            <b>Address: </b>Anna nagar,chennai-600040<br><br>
            <b>Email: </b>dataspheretech@gmail.com<br><br>
            <b>Phone: </b>044-8464830454
        </div>
        <div class="vl"></div>
    </div>
                <footer>
